...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-br from-red-300 via-red-400 to-rose-600/90 backdrop-blur-md border-b border-white/20 shadow-sm text-white">
