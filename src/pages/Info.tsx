...
const Info = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-100 to-pink-200 flex items-center justify-center p-4 sm:p-6">
      <div className="max-w-3xl w-full bg-white/70 backdrop-blur-lg shadow-xl rounded-2xl p-6 sm:p-8 border border-gray-200 space-y-6">
        ...
        <div className="space-y-4 text-gray-800 text-sm sm:text-base leading-relaxed">
          ...
          <div>
            ...
            <ul className="list-disc list-inside ml-4">
              <li>Wajib mendapatkan <strong>approve</strong> dari <strong>Pak Yusuf</strong>, selaku Manager DC.</li>
              <li>Setelah approve, segera <strong>input link</strong> percepatan.</li>
              <li>Jangan lupa untuk <strong>release</strong> setelah input dilakukan.</li>
            </ul>
          </div>
        </div>
